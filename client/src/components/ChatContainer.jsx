...
const ChatContainer = () => {
  ...
  return selectedUser ? (
    <div className='h-full overflow-scroll relative backdrop-blur-lg flex flex-col'>
      ...
      <div className='flex flex-col flex-1 overflow-y-scroll overflow-hidden p-3 pb-6'>
    ...
    <div className='flex flex-col items-center gap-2 text-gray-500 bg-white/10 max-md:hidden justify-center h-full'>
